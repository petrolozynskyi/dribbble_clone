            ...
            <div className='flex items-center justify-between px-[40px]'>
                <div className="h-[100px] flex  items-center :hover-pointer">
                    <nav>
                        <ul className='xyu flex row justify-center items-center'>
                            ...
                            <li>
                                <a className='pidor' href="/about">Inspiration</a>
                            </li>
                            <li className="group hover-trigger">
                            ...
                            <li>
                                <a className='pidor' href="/blog">Jobs</a>
                            </li>
                            <li>
                                <a className='pidor' href="/contact">Go Pro</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div className="flex items-center">
                    <form className="flex relative pl-[48px] pr-[24px]">
                        <svg href="#home" className="cursor-pointer opacity-[0.5] absolute top-[50%] left-[70px] translate-y-[-50%]" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" role="img">
